  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_lg span3"> <a href="{{ url('/admin/donate') }}"> <i class="icon-signal"></i> Donate </a> </li>
        <li class="bg_lo span3"> <a href="{{ url('/logout') }}"> <i class="icon-th-list"></i> Log Out </a> </li>
