...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('css/frontend_css/open-iconic-bootstrap.min.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/frontend_css/jquery.timepicker.css') }}">   
    <link rel="stylesheet" href="{{ asset('css/frontend_css/flaticon.css') }}">
    <link rel="stylesheet" href="{{ asset('css/frontend_css/icomoon.css') }}">
  ...
  <body>
      <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
          <a class="navbar-brand" href="index.html">Content Hub</a>
          ...
          <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item active">
              <input type="text" name="search_box" id="search" class="nav-item nav-link search_box" placeholder="Search..." onclick ="return findInPage(this.string.value);">
            </li>
              <li class="nav-item"><a href="{{ url('/admin/homepage')}}" class="nav-link">Home</a></li>
              <li class="nav-item"><a href="{{ url('/admin/about')}}" class="nav-link">About</a></li>
              <li class="nav-item"><a href="{{ url('/admin/homepage')}}" class="nav-link">Domain</a></li>
              <li class="nav-item"><a class="nav-link" href="{{ url('/admin/hosting')}}">Hosting</a></li>
              <li class="nav-item"><a href="{{ url('/admin/blog')}}" class="nav-link">Blog</a></li>
              <li class="nav-item"><a href="{{ url('/admin/contact')}}" class="nav-link">Contact</a></li>
              <li class="nav-item cta"><a href="{{ url('/admin/homepage')}}" class="nav-link"><span>Get started</span></a></li>
            <li class="nav-item"><a href="{{url('/admin')}}" class="nav-link">Log In</a></li>
            </ul>
          </div>
        </div>
      </nav>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url(../images/frontend_images/bg_1.jpg);">
        <div class="overlay"></div>
        <div class="container-fluid">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">

            <div class="col-md-5 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Everything you get what you need to share your content</h1>
              <p class="mb-4 mb-md-5 sub-p" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">Sign up today</p>
            ...
            <div class="col-md-7 ftco-animate">
                <img src="../images/frontend_images/dashboard_full_1.png" class="img-fluid" alt="">
            </div>
      ...
      <div class="slider-item" style="background-image: url(../images/frontend_images/bg_2.jpg);">
        <div class="overlay"></div>
        <div class="container-fluid">
          <div class="row slider-text align-items-center" data-scrollax-parent="true">

            <div class="col-md-5 wrap col-sm-12 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
              <h1 class="mb-4 mt-5" data-scrollax="properties: { translateY: '30%', opacity: 1.6 }">The Content Sharing Platform Made for You</h1>
              <p class="mb-4 mb-md-5">This is the way</p>
              <p><a href="#" class="btn btn-primary p-3 px-xl-5 py-xl-3">Get started</a> <a href="#" class="btn btn-primary btn-primary-2 p-3 px-xl-5 py-xl-3">Read more</a></p>
            </div>
            <div class="col-md-7 ftco-animate">
                <img src="{{ asset('../images/frontend_images/dashboard_full_3.png') }}" class="img-fluid" alt="">
            </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 text-center heading-section ftco-animate">
            <h2 class="mb-4">The Content Hub Guarantee</h2>
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(../images/frontend_images/bg_1.jpg);" data-stellar-background-ratio="0.5">
        <div class="container">
        ...
        <section class="ftco-services">
            <div class="container-wrap">
                <div class="row no-gutters">
                    <div class="col-lg-5 img services-img" style="background-image: url(../images/frontend_images/bg_1.jpg);" data-stellar-background-ratio="0.5">
                <a href="https://vimeo.com/45830194" class="icon popup-vimeo d-flex justify-content-center align-items-center">
                    ...
                    <span class="subheading">Peoples Choice Content Hub The Best Content Sharing</span>
                  </div>
                    <div class="d-md-flex">
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(../images//frontend_images/person_1.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text">
                    <p class="mb-5">Subsribe to Content Hub!</p>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(../images/frotnend_images/person_2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text">
                    <p class="mb-5">What a service!</p>
                    <p class="name">Mark Web</p>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(../images/frontend_images/person_3.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
                  <div class="text">
                    <p class="mb-5">Best till today</p>
                    <p class="name">Mark Web</p>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-5">This is the way</p>
                    <p class="name">Mark Web</p>
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  ...
                  <div class="text">
                    <p class="mb-5">The force is strong with this one</p>
                    <p class="name">Mark Web</p>
              ...
              <div class="tab-pane fade show active" id="v-pills-nextgen" role="tabpanel" aria-labelledby="v-pills-nextgen-tab">
                <div class="d-md-flex">
                    <div class="one-forth align-self-center">
                        <img src="../images/frontend_images/dashboard_full_1.jpg" class="img-fluid border" alt="">
                    </div>
              ...
              <div class="tab-pane fade" id="v-pills-performance" role="tabpanel" aria-labelledby="v-pills-performance-tab">
                <div class="d-md-flex">
                    <div class="one-forth order-last align-self-center">
                        <img src="../images/frontend_images/dashboard_full_2.jpg" class="img-fluid border" alt="">
                    </div>
          ...
          <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
            ...
            <div class="row">
                <div class="col-sm ftco-animate">
                    <a href="#" class="partner"><img src="../images/frontend_images/partner-1.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-sm ftco-animate">
                    <a href="#" class="partner"><img src="../images/frontend_images/partner-2.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-sm ftco-animate">
                    <a href="#" class="partner"><img src="../images/frontend_images/partner-3.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-sm ftco-animate">
                    <a href="#" class="partner"><img src="../images/frontend_images/partner-4.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
                <div class="col-sm ftco-animate">
                    <a href="#" class="partner"><img src="../images/frontend_images/partner-5.png" class="img-fluid" alt="Colorlib Template"></a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="row">
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry">
              <a href="blog-single.html" class="block-20" style="background-image: url('../images/frontend_images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="100">
              <a href="blog-single.html" class="block-20" style="background-image: url('../images/frontend_images/image_2.jpg');">
              </a>
              <div class="text d-flex py-4">
                <div class="meta mb-3">
                  <div><a href="#">Sep. 20, 2018</a></div>
          ...
          <div class="col-md-4 ftco-animate">
            <div class="blog-entry" data-aos-delay="200">
              <a href="blog-single.html" class="block-20" style="background-image: url('../images/frontend_images/image_3.jpg');">
              </a>
              <div class="text d-flex py-4">
                <div class="meta mb-3">
                  <div><a href="#">Sep. 20, 2018</a></div>
        ...
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2">Content Hub</h2>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
                ...
                <div class="block-23 mb-3">
                  <ul>
                    <li><span class="icon icon-map-marker"></span><span class="text">203, Dhaka, Bangladesh</span></li>
  ...
  <script src="{{ asset('js/frontend_js/jquery.timepicker.min.js') }}"></script>
  <script src="{{ asset('js/frontend_js/scrollax.min.js') }}"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=Gf9m5PCwpwb1EG9XyJgwVosLWYX7URUBcFY0H2s&sensor=false"></script>
