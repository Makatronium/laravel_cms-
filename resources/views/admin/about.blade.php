...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item bread-item" style="background-image: url(../images/frontend_images/bg_1.jpg);" data-stellar-background-ratio="0.5">
    ...
    <section class="ftco-section bg-light">
    	<div class="container">
    		<div class="row d-md-flex">
	    		<div class="col-md-6 ftco-animate img about-image" style="background-image: url(../images/frontend_images/about.jpg);">
	    		</div>
		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-whatwedo" role="tabpanel" aria-labelledby="v-pills-whatwedo-tab">
		              	<div>
			                <h2 class="mb-4">Offering Reliable Content Sharing</h2>
			              	<p>Join us</p>
			                <p>We create what others can not</p>
				            </div>
		              </div>
        ...
        <div class="row ftco-animate">
          <div class="col-md-12">
            <div class="carousel-testimony owl-carousel ftco-owl">
              ...
              <div class="item">
                <div class="testimony-wrap p-4 pb-5">
                  <div class="user-img mb-5" style="background-image: url(../images/frontend_images/person_2.jpg)">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-5">
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <p>Let's met our team members</p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              <div class="person-info mb-2">
                <span class="name">Maksudur Rahman Niloy</span>
                <span class="position">Lead Web Developer</span>
              </div>
              <img src="{{asset('images/frontend_images/niloy.jpg') }}" alt="" class="img-fluid mb-3">
          ...
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              <div class="person-info mb-2">
                <span class="name">Jannatul Nayeem Himel</span>
                <span class="position">Web Developer</span>
              </div>
              <img src="{{ asset('images/frontend_images/himel.jpg') }}" alt="" class="img-fluid mb-3">
          ...
          <div class="col-md-4 mb-5 ftco-animate">
            <div class="block-10">
              ...
              <img src="{{ asset('images/frontend_images/person_3.jpg') }}" alt="" class="img-fluid mb-3">
              <p>A good product is what we try to give</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                <li><span class="icon icon-map-marker"></span><span class="text">203, Dhanmondi, Dhaka, Bangladesh.</span></li>
